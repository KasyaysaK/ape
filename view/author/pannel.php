<?php $title = htmlspecialchars('Gestionnaire des articles'); ?>
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12 mb-4" data-aos="fade-down">
    		<fieldset>
			  	<legend><a data-toggle="collapse" href="#add-post" role="button" aria-expanded="false" aria-controls="add-post">Ajouter un article</h4></a></legend>
	...
	<div class="d-flex align-items-center justify-content-between">	
		...
		<a href="index.php?action=list_posts">Tous les articles</a>
	</div>
	<hr class="mb-3" />
	<div class="notice">
		
	</div>
		<form id="add_post" class="row" action="index.php?action=publish_post"  onsubmit="return validateAddPost()" method="POST">
			<div class="col-md-10">
